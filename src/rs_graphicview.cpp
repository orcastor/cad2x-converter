	...
	,drawingMode(RS2::ModeFull)
{
    ...
    setSelectedColor(Colors::select);
    setHighlightedColor(Colors::highlight);
    setStartHandleColor(Colors::start_handle);
    setHandleColor(Colors::handle);
    setEndHandleColor(Colors::end_handle);
}
