...
/*!
    ...
    \since 5.1
*/
QSupportedWritingSystems writingSystemsFromTrueTypeBits(quint32 unicodeRange[4], quint32 codePageRange[2])
{
...
QList<QFontDatabase::WritingSystem> QRawFont::supportedWritingSystems() const
{
    ...
    if (d->isValid()) {
        ...
        if (os2Table.size() > 86) {
            ...
            QSupportedWritingSystems ws = writingSystemsFromTrueTypeBits(unicodeRanges, codepageRanges);
            for (int i = 0; i < QFontDatabase::WritingSystemsCount; ++i) {
