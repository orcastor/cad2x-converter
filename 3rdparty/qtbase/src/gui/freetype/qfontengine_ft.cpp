...
static QFontEngine::SubpixelAntialiasingType subpixelAntialiasingTypeHint()
{
    ...
    if (type == -1) {
        ...
        case 0:
            type = static_cast<int>(QFontEngine::Subpixel_None);
            break;
        case 1:
            type = static_cast<int>(QFontEngine::Subpixel_RGB);
            break;
        case 2:
            type = static_cast<int>(QFontEngine::Subpixel_BGR);
            break;
        default:
            type = static_cast<int>(QFontEngine::Subpixel_None);
            break;
        ...
        if (env == "RGB")
            ...
            type = static_cast<int>(QFontEngine::Subpixel_VRGB);
        else if (env == "VBGR")
            type = static_cast<int>(QFontEngine::Subpixel_VBGR);
        else
            type = static_cast<int>(QFontEngine::Subpixel_None);
#endif
    }
